...
```
ANTHROPIC_BASE_URL="https://api.anthropic.com"   # API 服务地址
ANTHROPIC_API_KEY="sk-ant-xxxxxxxxxxxx"          # API 密钥
```
...
路径|方案|成本|延迟|推荐度
-|-|-|-|-|
路径A|国产模型直连|低（有免费额度）|低|⭐⭐⭐⭐⭐
路径B|中转 API（用官方模型）|中|中|⭐⭐⭐
路径C|本地模型（Ollama 等）|零|极低|⭐⭐
